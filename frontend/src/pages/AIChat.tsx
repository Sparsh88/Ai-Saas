    ...
    <div className="h-[calc(100vh-10rem)] md:h-[calc(100vh-8.5rem)] flex flex-col justify-between max-w-4xl mx-auto rounded-2xl bg-white dark:bg-[#0d0d0d] border border-slate-200 dark:border-[#1c1c1c] overflow-hidden shadow-sm relative">
      ...
      <div className="px-4 py-3 md:px-6 md:py-4 border-b border-slate-200 dark:border-[#1c1c1c] flex flex-col sm:flex-row gap-3 sm:items-center justify-between bg-slate-50 dark:bg-[#000000]">
        <div className="flex items-center gap-2.5">
          <div className="w-8 h-8 rounded-xl bg-blue-50 dark:bg-blue-500/10 border border-blue-200 dark:border-blue-500/20 text-blue-600 dark:text-[#3b82f6] flex items-center justify-center">
            <BrainCircuit className="w-4.5 h-4.5" />
          </div>
          <div>
            <h2 className="text-sm font-bold text-slate-900 dark:text-white font-heading">Interactive Workspace</h2>
            <p className="text-[11px] text-slate-500 dark:text-slate-400">Ask coding prompts or load PDF records</p>
          </div>
        </div>
      ...
      <div className="flex-1 overflow-y-auto p-4 md:p-6 space-y-4">
        ...
        {error && (
          <div className="flex items-center gap-2 p-3.5 rounded-xl bg-rose-500/10 border border-rose-500/20 text-rose-600 dark:text-rose-400 text-xs max-w-md mx-auto">
      ...
      {/* Input Form Bar */}
      <form onSubmit={handleSend} className="px-4 py-3 md:px-6 md:py-4 border-t border-slate-200 dark:border-[#1c1c1c] bg-white dark:bg-[#000000] flex items-center gap-3">
        <input
          type="text"
          value={input}
