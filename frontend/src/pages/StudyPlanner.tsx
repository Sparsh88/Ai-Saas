            ...
            <div className="p-6 rounded-2xl bg-white dark:bg-[#0d0d0d] border border-slate-200 dark:border-[#1c1c1c] flex flex-col justify-between shadow-sm">
              <form onSubmit={handleGenerateRoadmap} className="space-y-4">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full flex items-center justify-center gap-2 mt-4 bg-[#3b82f6] hover:bg-[#2563eb] text-white rounded-xl py-3 font-semibold text-xs transition-all shadow-md shadow-blue-500/25 disabled:opacity-50 cursor-pointer"
                >
              ...
              {roadmap ? (
                <div className="space-y-6">
                  ...
                  <div className="relative pl-6 space-y-6">
                    <div className="absolute left-2.5 top-2 bottom-2 w-0.5 timeline-line rounded-full bg-slate-200 dark:bg-[#222222]" />
                    
                    {roadmap.milestones.map((ms: any, idx: number) => (
                      <div key={idx} className="relative text-xs">
                        {/* Dot indicator */}
                        <div className="absolute -left-[22px] top-1.5 w-3.5 h-3.5 bg-white dark:bg-[#000000] border-2 border-[#3b82f6] rounded-full flex items-center justify-center shadow-sm" />
                        ...
                        <div className="p-4 rounded-xl border border-slate-200 dark:border-[#222222] bg-slate-50 dark:bg-[#111111] space-y-2">
                          <div className="flex items-center justify-between">
                            ...
                            <span className="text-[10px] font-semibold text-blue-600 dark:text-blue-400 bg-blue-500/10 px-2 py-0.5 rounded">{ms.duration}</span>
                          </div>
                ...
                <div className="h-full flex flex-col items-center justify-center text-slate-400 dark:text-slate-600 py-16 gap-3">
                  <Map className="w-8 h-8 text-slate-300 dark:text-slate-700" />
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {studyPlan.weeklySchedule.map((week: any, wIdx: number) => (
                      <div key={wIdx} className="p-4 rounded-xl border border-slate-200 dark:border-[#222222] bg-slate-50 dark:bg-[#111111] flex flex-col justify-between">
                        <div className="mb-3">
                          <span className="text-[10px] font-bold text-blue-600 dark:text-blue-400 bg-blue-500/10 px-2 py-0.5 rounded uppercase tracking-wider">{week.week}</span>
                ...
                <div className="space-y-4 flex-1 flex flex-col justify-between">
                  <div>
                    ...
                    <div className="flex items-center justify-between border-b border-slate-200 dark:border-white/5 pb-2.5 mb-4">
                      <span className="text-[10px] font-bold text-blue-600 dark:text-blue-400 bg-blue-500/10 px-2.5 py-0.5 rounded tracking-wide">
                      ...
                      {evaluation && (
                        ...
                        >
                          <div className="flex items-center justify-between">
                            ...
                            <span className="text-xs font-bold text-blue-600 dark:text-blue-400 bg-blue-500/10 px-2 py-0.5 rounded">Score: {evaluation.score}/100</span>
                          </div>
                          ...
                          {speechAnalysis && (
                            <div className="grid grid-cols-2 gap-4 border-t border-slate-200 dark:border-white/5 pt-3 text-[11px]">
                              <div>
                                ...
                                <p className="text-slate-700 dark:text-slate-300 font-semibold">{speechAnalysis.speakingRateWPM} WPM ({speechAnalysis.pacingFeedback})</p>
                              </div>
                              <div>
                  ...
                  <div className="flex gap-3 justify-end border-t border-slate-200 dark:border-white/5 pt-4 mt-6">
                    {!evaluation ? (
                      <button
                        ...
                        className="flex items-center gap-1.5 bg-[#3b82f6] hover:bg-[#2563eb] text-white rounded-xl px-4 py-2 text-xs font-semibold shadow-md shadow-blue-500/25 disabled:opacity-50 cursor-pointer"
                      >
                      ...
                      currentQuestionIndex < 2 ? (
                        <button
                          ...
                          className="flex items-center gap-1 bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/5 text-slate-700 dark:text-slate-300 hover:text-blue-600 dark:hover:text-blue-400 px-4 py-2 rounded-xl text-xs font-semibold cursor-pointer"
                        >
