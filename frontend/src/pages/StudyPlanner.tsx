      ...
      <div className="flex gap-2 border-b border-white/5 pb-2 overflow-x-auto whitespace-nowrap scrollbar-none -mx-1 px-1">
        {[
          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2.5 text-xs font-semibold rounded-xl transition-all shrink-0 cursor-pointer ${
              activeTab === tab.id
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch">
            ...
            <div className="p-6 rounded-2xl bg-[#0d1017] border border-white/5 flex flex-col justify-between">
              <form onSubmit={handleGenerateRoadmap} className="space-y-4">
                ...
                <p className="text-xs text-zinc-400 mb-6">Create customized skill paths based on your desired goals.</p>
                <div>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full flex items-center justify-center gap-2 mt-4 bg-blue-600 hover:bg-blue-500 text-white rounded-xl py-3 font-semibold text-xs transition-all shadow-lg shadow-blue-600/30 active:scale-95 disabled:opacity-50 cursor-pointer"
                >
            ...
            <div className="lg:col-span-2 p-6 rounded-2xl bg-[#0d1017] border border-white/5 min-h-[350px]">
              {roadmap ? (
                <div className="space-y-6">
                  ...
                  <div className="relative pl-6 space-y-6">
                    <div className="absolute left-2.5 top-2 bottom-2 w-0.5 bg-blue-600/30 rounded-full" />
                    
                    {roadmap.milestones.map((ms: any, idx: number) => (
                      <div key={idx} className="relative text-xs">
                        {/* Dot indicator */}
                        <div className="absolute -left-[22px] top-1.5 w-3.5 h-3.5 bg-[#0d1017] border-2 border-blue-500 rounded-full flex items-center justify-center shadow-lg" />
                        
                        <div className="p-4 rounded-xl border border-white/5 bg-[#12151e] space-y-2">
                          ...
                          <div className="space-y-1">
                            <span className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest">Topics to cover</span>
                            <div className="flex flex-wrap gap-1.5">
                              {ms.topics.map((t: string, i: number) => (
                                <span key={i} className="text-[10px] px-2 py-0.5 bg-white/5 rounded text-zinc-300 border border-white/5">{t}</span>
                              ))}
                            </div>
                          </div>

                          <div className="space-y-1 pt-1.5 border-t border-white/5">
                            <span className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest">Milestone project challenge</span>
                ...
                <div className="h-full flex flex-col items-center justify-center text-zinc-500 py-16 gap-3">
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {studyPlan.weeklySchedule.map((week: any, wIdx: number) => (
                      <div key={wIdx} className="p-4 rounded-xl border border-white/5 bg-[#12151e] flex flex-col justify-between">
                        <div className="mb-3">
                          ...
                          <h5 className="text-xs font-bold text-zinc-200 mt-2">{week.goal}</h5>
                        </div>
                        <div className="space-y-2 border-t border-white/5 pt-2 text-[11px]">
                          {week.days.map((d: any, dIdx: number) => (
                            <div key={dIdx} className="flex gap-2 text-zinc-400">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch">
            ...
            <div className="p-6 rounded-2xl bg-[#0d1017] border border-white/5 flex flex-col justify-between">
              <form onSubmit={handleStartInterview} className="space-y-4">
                ...
                <p className="text-xs text-zinc-400 mb-6">Test yourself against simulated technical and behavioral prompts.</p>
            ...
            <div className="lg:col-span-2 p-6 rounded-2xl bg-[#0d1017] border border-white/5 min-h-[350px] flex flex-col justify-between">
                ...
                <div className="space-y-4 flex-1 flex flex-col justify-between">
                  <div>
                    ...
                    <div className="flex items-center justify-between border-b border-white/5 pb-2.5 mb-4">
                      ...
                      <span className="text-[10px] text-zinc-400 font-semibold">Targets: {interviewQuestions[currentQuestionIndex].optimalKeywords.slice(0, 2).join(', ')}</span>
                    </div>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center justify-between">
                        <label className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest">Your Answer Response</label>
                      ...
                      {evaluation && (
                        ...
                        >
                          <div className="flex items-center justify-between">
                            ...
                            <span className="text-xs font-black text-blue-400">Score: {evaluation.score}/100</span>
                          </div>
                          
                          <p className="text-xs text-zinc-300 leading-relaxed bg-[#12151e] p-3.5 rounded-xl border border-white/5">{evaluation.feedback}</p>
                          
                          {speechAnalysis && (
                            <div className="grid grid-cols-2 gap-4 border-t border-white/5 pt-3 text-[11px]">
                              <div>
                                <span className="font-bold text-zinc-500 block uppercase tracking-wider mb-1">Speaking Pacing</span>
                                <p className="text-zinc-200 font-semibold">{speechAnalysis.speakingRateWPM} WPM ({speechAnalysis.pacingFeedback})</p>
                              </div>
                              <div>
                                <span className="font-bold text-zinc-500 block uppercase tracking-wider mb-1">Purity (Filler Words)</span>
                  ...
                  <div className="flex gap-3 justify-end border-t border-white/5 pt-4 mt-6">
                    {!evaluation ? (
                      <button
                        ...
                        className="flex items-center gap-1.5 bg-blue-600 hover:bg-blue-500 text-white rounded-xl px-4 py-2 text-xs font-semibold shadow-lg shadow-blue-600/30 disabled:opacity-50 cursor-pointer"
                      >
                      ...
                      currentQuestionIndex < 2 ? (
                        <button
                          ...
                          className="flex items-center gap-1 bg-white/5 border border-white/10 hover:border-blue-500/30 text-zinc-300 hover:text-white px-4 py-2 rounded-xl text-xs font-semibold cursor-pointer"
                        >
                        ...
                        <button
                          ...
                          className="bg-blue-600 hover:bg-blue-500 text-white px-4 py-2 rounded-xl text-xs font-semibold shadow-lg shadow-blue-600/30 cursor-pointer"
                        >
                          Finish Session 🏁
                        </button>
                      )
